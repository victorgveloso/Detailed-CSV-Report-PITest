...
public class SurvivedTestsDescriber extends AbstractTestDescriber {
    public SurvivedTestsDescriber(ReportFormatter reportFormatter, MutationDescriber mutationDescriber) {
